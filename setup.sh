...
if [ "$1" = "--get-checkpoint" ]; then
    mkdir -p ./checkpoints/backup-checkpoint-24-0/ && wget -O ./checkpoints/backup-checkpoint-24-0/ckpt.pt https://github.com/edizucar/adversarially-training-transformers/releases/download/pretrain_checkpoint/backup_checkpoint_24_02_ckpt.pt
